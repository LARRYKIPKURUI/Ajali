...
const Home = () => {
  ...
  // New function to handle the report incident click
  ...
  return (
    <div style={{ backgroundColor: "#ffeaea", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
      <section className="d-flex align-items-center justify-content-center  text-center w-100">
        <div className="px-3 ">
          {/* Alert Icon */}
          <img
            src={heroImage}
          ...
          {/* Title */}
          <h1 className="fw-bold text-danger" style={{ fontSize: "4rem" }}>
            Ajali!
          </h1>
          ...
          {/* Paragraph */}
          <p
            className="text-semibold fs-5 mb-4 mx-auto"
